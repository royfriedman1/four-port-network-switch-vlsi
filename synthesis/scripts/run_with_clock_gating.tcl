...
########################################################################
# Clean previous run
file delete -force switch_4port_with_cg_f.dlib

create_lib  -technology $TECH_FILE  -ref_libs { /data/synopsys/lib/saed32nm/ref/CLIBs/saed32_hvt.ndm /data/synopsys/lib/saed32nm/ref/CLIBs/saed32_lvt.ndm /data/synopsys/lib/saed32nm/ref/CLIBs/saed32_rvt.ndm }  switch_4port_with_cg_f.dlib
open_lib switch_4port_with_cg_f.dlib
report_ref_libs
...
file mkdir reports_with_cg_f
report_timing -delay_type max > reports_with_cg_f/timing_setup.rpt
report_timing -delay_type min > reports_with_cg_f/timing_hold.rpt
report_area > reports_with_cg_f/area.rpt
report_power > reports_with_cg_f/power.rpt
report_resources > reports_with_cg_f/resources.rpt
current_block switch_4port

#change_names -hierarchy -rules verilog
#uniquify
write_verilog switch_4port_with_cg_f.v
write_sdf switch_4port_with_cg_f.sdf
